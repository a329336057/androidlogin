...
public abstract class LoadingFrame extends FrameLayout {
    ...
    private void createNetErrorView() {
        ...
        netErrorView.setImageResource(R.drawable.ic_launcher_background);
    ...
    private void createNoDataView() {
        ...
        noDataView.setImageResource(R.drawable.ic_launcher_background);
    ...
    private void createLoadingView() {
        ...
        loadingView.setImageResource(R.drawable.ic_launcher_background);
